export interface Runeword {
    ...
    version: '1.09' | '1.10' | '1.11' | '2.4' | '2.6' | 'RotW';
}
...
export const RUNEWORDS: Runeword[] = [
    ...
    },
    {
        ...
        levelreq: 39,
        name: 'Hustle',
        notes: ['RotW: Renamed to Mania (Body Armors) & Hysteria (Weapons)'],
        runes: ['Shael', 'Ko', 'Eld'],
        sockets: 3,
        stats: {
            'Body Armors': [
    ...
    },
    {
        ...
        stats: {
            all: [
                ...
                '+10 to Vitality',
                'Fire Resist +30%',
                '+1-5 Life After Each Kill (varies)',
    ...
    },
    {
        ...
        stats: {
            all: [
                ...
                '40% Increased Attack Speed',
                '+250-320% Enhanced Damage (varies)',
                '200-260% Bonus To Attack Rating (varies)',
                '+150-250% Damage To Demons (varies)',
                '7% Life Stolen Per Hit',
                'Slain Monsters Rest In Peace',
                '+3-5 Life After Each Kill (varies)',
            ]
        },
        version: 'RotW'
    },
